...
% --- SHADED PLANES ---
% xy-plane (z=0)
\fill[magenta!10, opacity=0.6] (0,0,0) -- (7,0,0) -- (7,7,0) -- (0,7,0) -- cycle;

% yz-plane (x=0)
\fill[green!10, opacity=0.6] (0,0,0) -- (0,7,0) -- (0,7,7) -- (0,0,7) -- cycle;

% zx-plane (y=0)
\fill[green!10, opacity=0.6] (0,0,0) -- (7,0,0) -- (7,0,7) -- (0,0,7) -- cycle;
